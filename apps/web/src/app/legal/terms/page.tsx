...
Self-custody actions are separately unavailable to any person or entity located in, incorporated in, or a resident of the People's Republic of China (excluding the Hong Kong and Macao Special Administrative Regions and Taiwan). This is not a pending-review exclusion: the People's Bank of China's September 2021 notice ("Notice on Further Preventing and Disposing of the Risks of Speculation in Virtual Currency Trading", 关于进一步防范和处置虚拟货币交易炒作风险的通知) declares crypto-asset business activity illegal and expressly extends that prohibition to offshore platforms serving mainland Chinese residents over the internet — an already-effective restriction, not a regime awaiting review.`,
  ...
  es: [
    ...
    },
    {
      ...
      content: `Las acciones de auto-custodia de treasury y payouts (las funciones que construyen una transacción para que usted la firme en su propia wallet) no se ofrecen, y no pueden ser usadas por, ninguna persona o entidad ubicada, constituida, o residente en: (a) cualquier estado miembro de la Unión Europea o del Espacio Económico Europeo, donde el Reglamento (UE) 2023/1114 (MiCA) establece un régimen de licencias a nivel de toda la unión para proveedores de servicios de activos criptográficos; o (b) Estados Unidos, donde la transmisión de dinero está regulada a nivel federal por FinCEN bajo la Bank Secrecy Act y por separado por hasta cincuenta regímenes estatales de licencias. Estas dos reflejan jurisdicciones con un régimen bien documentado que aún no hemos revisado para este patrón no-custodio específico — no es una afirmación de que Contextio esté confirmado como seguro en cualquier otro lugar, solo que estas dos tienen un costo específico, conocido y material de equivocarse.
        ...
        <div className="flex-1 space-y-10 lg:w-3/4">
          <div className="space-y-4 border-b border-white/10 pb-6">
            ...
            <div className="flex items-center gap-2.5 text-xs text-slate-500">
              <span>{t("legal.lastUpdated")}: August 16, 2026</span>
              <span>•</span>
